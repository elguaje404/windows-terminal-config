...
### Perfil de PowerShell (`Microsoft.PowerShell_profile.ps1`)
...
Copia el archivo `Microsoft.PowerShell_profile.ps1` en la carpeta de perfiles de PowerShell Core:

* Ruta: `Documentos\PowerShell\Microsoft.PowerShell_profile.ps1`
